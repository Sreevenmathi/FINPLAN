...
if (isset($_POST['submit'])) {
    ...
    if (isset($_SESSION['aId2'])) {
        ...
        $sql = "SELECT * FROM adv_reg WHERE email = '$username' AND password = '$h_password' AND stat=2";
        ...
        if ($count == 1) {
            $_SESSION['aId2'] = $username; // Set session ID
...
<head>
    <meta charset="utf-8">
    <title>FINPLAN - Advisor Login</title>
                ...
                <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
                    <div class="bg-secondary rounded p-4 p-sm-5 my-4 mx-3">
                        ...
                        <form action="" method="POST">
                            ...
                            <button type="submit" value="submit" name="submit" class="btn btn-primary py-3 w-100 mb-4">Login</button>
                            <p class="text-center mb-0">Don't have an account? <a href="advsr_reg.php">Sign Up</a></p>
                        </form>
                    </div>
                </div>
            </div>
