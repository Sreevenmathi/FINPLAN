...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt = $connection->prepare("INSERT INTO goals (goal_name, target_amount, start_date, target_date, monthly_contribution, priority_level, category, notes,user_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?,?)");
    $stmt->bind_param("sdssdssss", $goalName, $targetAmount, $startDate, $targetDate, $monthlyContribution, $priorityLevel, $category, $notes,$usr);
...
// Retrieve last inserted goal for display
$result = $connection->query("SELECT * FROM goals ORDER BY id DESC LIMIT 1");
                ...
                <div class="bg-secondary rounded h-100 p-4">
                    ...
                    <?php if (isset($latestGoal)) { ?>
                        <div class="form-check form-switch">
                            <label class="form-check-label" for="flexSwitchCheckDefault">GOAL NAME: <?php echo htmlspecialchars($latestGoal['goal_name']); ?></label><br>
                            <label class="form-check-label" for="flexSwitchCheckDefault">GOAL TYPE: <?php echo htmlspecialchars($latestGoal['category']); ?></label><br>
                            <label class="form-check-label" for="flexSwitchCheckDefault">PRIORITY: <?php echo htmlspecialchars($latestGoal['priority_level']); ?></label><br>
                            <label class="form-check-label" for="flexSwitchCheckDefault">TARGETED AMOUNT: <?php echo htmlspecialchars($latestGoal['target_amount']); ?></label>
                        </div>
                    <?php } else { ?>
